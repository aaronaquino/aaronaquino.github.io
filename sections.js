...
document.getElementById("copyright-footer").innerHTML =
	...
	" Copyright <a class='link-no-underline w3-hover-text-strawberry-red' href='home.html'>Aaron Aquino</a>. All rights reserved.";
...
document.getElementById("menu").innerHTML = "<ul class='w3-navbar w3-large w3-padding-8 w3-white w3-container'>" +
	"<a class='w3-hover-white' href='home.html'><img src='images/ninja.svg' alt='Logo' id='logo' class='w3-small'></a>" + 
	...
	"<li class='w3-right'><a class='w3-text-carbon w3-hover-white w3-hover-text-strawberry-red' href='home.html'>HOME</a></li>" +
	"</ul>";
